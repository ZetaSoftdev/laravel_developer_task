...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('lesson_topics')) {
        ...
        if (!Schema::hasTable('promote_students')) {
        ...
        if (!Schema::hasTable('online_exam_question_options')) {
        ...
        if (!Schema::hasTable('online_exam_question_choices')) {
        ...
        if (!Schema::hasTable('student_online_exam_statuses')) {
        ...
        if (!Schema::hasTable('online_exam_student_answers')) {
        ...
        if (!Schema::hasTable('installment_fees')) {
        ...
        if (!Schema::hasTable('fees_classes')) {
        ...
        if (!Schema::hasTable('addon_subscriptions')) {
        ...
        if (!Schema::hasTable('subscription_bills')) {
        ...
        if (!Schema::hasTable('staff_support_schools')) {
